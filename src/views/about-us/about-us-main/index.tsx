...
export default function AboutUsMain({ home }: propsType): JSX.Element {
  return (
    <Container className={`${home ? "pt-28 pb-40" : "py-20"}`}>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className=" ">
          {home ? (
            <div className="w-full h-[28rem] sm:h-[32rem] lg:w-[30rem] relative ml-auto">
              <CommonImage
        ...
        <div className="px-4">
          ...
          <div className="mt-8">{aboutUSMainData.button}</div>
        </div>
      </div>
    </Container>
  );
